...
STAT4_VOLTAGE_118_B	=	0x5
STAT4_V_LOWER_126_B	=	0x6
...
VOLTAGE_CHECK_SYS:
		...
		BCR		RG_STAT4_WORD,STAT4_VOLTAGE_118_B
		MOVIA   0x0C9		;11.8V Value(0XC96) 11.777V
		SUBAR	RG_VOL_L,A
		BTRSC   STATUS,C_B
		BSR		RG_STAT4_WORD,STAT4_VOLTAGE_118_B
		...
		MOVIA   0x0DA		;12.773V Value(0XDA0)
		SUBAR	RG_VOL_L,A
		BTRSC   STATUS,C_B
...
NOW_INPUT2_LOW:
		INCR	RG_V_LOWER_126_CNT,R
		BTRSC	RG_STAT1_WORD,STAT1_INPUT2_B
		LGOTO	INPUT2_LOW_CHECK

;		BSR		RG_STAT4_WORD,STAT4_V_LOWER_126_B
		CLRR	RG_INPUT2_CNT
		RET
...
NOW_POW_OFF:	
		...
		BCR		RG_STAT2_WORD,STAT2_CAN_SYS_B
		BCR		RG_STAT4_WORD,STAT4_CANH_134S_B

		BTRSS	RG_STAT4_WORD,STAT4_VOLTAGE_118_B
		RET
...
;		RET
	UP_13V_START:
		BTRSC	RG_STAT4_WORD,STAT4_V_LOWER_126_B
		LGOTO	UP_13V_CHECK
		BTRSC	RG_V_LOWER_126_CNT,6
		BSR		RG_STAT4_WORD,STAT4_V_LOWER_126_B
		RET
	UP_13V_CHECK:
...
NOW_POW_ON:
		...
		BCR		RG_STAT4_WORD,STAT4_V_LOWER_126_B
		CLRR	RG_V_LOWER_126_CNT
	...
	NOW_CAN_CHECK:
	  ...
	  NOW_CAN_POWER_CHECK:
		...
		BTRSC	RG_STAT2_WORD,STAT2_CAN_TRI_B
		LGOTO	DO_CAN_POWER_CHECK
		BTRSS	RG_STAT4_WORD,STAT4_CANH_134S_B
		RET
	  DO_CAN_POWER_CHECK:	
		BTRSS	RG_STAT1_WORD,STAT1_INPUT_CAN_B
		LGOTO	CLEAR_POW_ON
...
MAIN:
		...
		BTRSC	RG_STAT4_WORD,STAT4_VOLTAGE_128_B
		LGOTO   VOLTAGE_128_UP
		CLRR	RG_128V_CNT
		BCR		RG_STAT2_WORD,STAT2_UP13V_B
		LGOTO   MAIN_2S_TASK
